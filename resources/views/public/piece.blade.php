...
<body id="page-top">
  ...
  <!-- Masthead -->
  <header class="masthead masthead-secondary bg-img-equipaments position-relative" style="background-position: 1% 80%">
    <div class="container h-100">
      <div class="row h-100 align-items-center justify-content-center text-center">
        <div class="col-lg-10 align-self-end">
          <h1 class="text-uppercase text-white font-weight-bold">{{ $piece->title }}</h1>
          <hr class="divider my-4">
        </div>
        <div class="col-lg-8 col-md-9 col-sm-9 col-9 align-self-baseline">
          <p class="text-white-75 font-weight-light mb-5">{{ $piece->author->name }}<br>{{ date('d/m/Y', strtotime($piece->created_at)) }}</p>
        </div>
      </div>
    </div>
    <div class="masthead-footer w-100 position-absolute text-center" style="bottom: 10px">
      <a href="{{ url('p/pecas') }}" class="text-white-75 font-weight-light" style="font-size: 12px">Voltar para Lista de Peças</a>
    </div>
  </header>

  <!-- Article -->
  <section class="page-section bg-primary text-white" style="min-height: 45vh">
    <div class="container col-md-10 col-sm-12">
      <div class="row justify-content-center">
        <div class="col-xl-12 col-sm-11 text-justify" style="font-size: 1.5em">
          @if ($piece->image == null)
            <i class="fas fa-rocket img-responsive text-center pt-5 text-dark mr-3" style="background-color:rgba(0, 0, 0, 0.1); height:450px; font-size:15em"></i>
          @else
